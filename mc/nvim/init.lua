...
-- vim.api.nvim_set_keymap("n", "ss", "gcc", { noremap = true, silent = true }) -- Command + /

--vim.api.nvim_set_keymap("v", "<A-;>", "gc", { noremap = true, silent = true }) -- Command + / in visual mode
-- vim.opt.ttimeoutlen = 100
vim.api.nvim_set_keymap("n", "[custom/]", "<cmd>lua require('Comment.api').toggle.linewise.current()<CR>", { noremap = true, silent = true }) -- Normal mode
vim.api.nvim_set_keymap("v", "[custom/]", "<cmd>lua require('Comment.api').toggle.linewise(vim.fn.visualmode())<CR>", { noremap = true, silent = true }) -- Visual mode
